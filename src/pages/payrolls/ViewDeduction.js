        ...
        <div className="container mt-2">
          ...
          <div className="    w-100    fs-5 col-12 col-lg-12 col-md-12 col-sm-12 d-flex justify-content-center gap-lg-4 align-items-center justify-content-center  flex-wrap">                                     
            ...
            <Form.Group  
             ...
             <button  className="   px-4 py-2 rounded mb-2" onClick={handleSubmit}>بحث</button>
             ...
             { data.deductions &&
              ...
              <h3 className="mt-3 mb-3">اجمالي الخصومات :{data.totalDeductions?  data.totalDeductions:0}</h3>                    
                ...
                :<h3>لا توجد استقطاعات من المرتب</h3>
              }
           ...
           { data.absences &&
            ...
            :<h3>لا توجد خصومات غياب </h3>
           }  

            { data.advance_deductions &&
              data.advance_deductions.length>0 ?
              <div className="mt-0   p-2 "style={{ }}> 
                <h3> خصومات السلف</h3>                         
                              ...
                              page={page}
                               ...
                               data={data.advance_deductions }                      
                                ...
                                search='name'                         
                                   role=''
                                /> 
              <h3 className="mt-3 mb-3">اجمالي خصومات السلف:{data.totalAdvanceDeductions?  data.totalAdvanceDeductions:0}</h3>                    
              </div>
               :<h3>لا توجد  سلف   </h3>
            }
